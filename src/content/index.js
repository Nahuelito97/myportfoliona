export default {
  ...
  header: {
    ...
    text: ["Site is under development", "I am Nahu Dev"],
    typical: [
      "from 📍 Misiones | Argentina 🇦🇷", 5000,
      "web developer. 💻", 5000,               
      "Full Stack Developer. 🖥️", 5000,       
      "🔭 I’m currently working to be a great developer.", 5000, 
    ],
  ...
  work: {
    ...
    projectName: "Seeping",
    desc: "peaceful, and tranquil mean quiet and free from disturbance. calm is used when someone is not excited or upset even when there is cause for it. They stayed calm during the fire. peaceful is used when someone or something has reached a quiet state after some period of disturbance.",
